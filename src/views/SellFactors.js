...
class SellFactors extends React.Component {
    constructor(props){
        super(props)
        this.state = {
            factors : [],
    ...
    handleSelect = (shopID) => {
        ...
        const config = {
            ...
            let url = `${models.URL}/sell/${shopID}?page[size]=10&sort[created_at]=desc`
    ...
    handleChangePage = (page) => {
        ...
        let url = `${models.URL}/sell/${this.state.shopID}?page[size]=10&page[number]=${page}&sort[created_at]=desc`
