                  ...
                  <CCard>
                    ...
                    <CCardBody>
                      ...
                      <CRow className="mb-3">
                        ...
                        <CCol xs="12" md="6">
                            <CFormGroup>
                                <CInput  name="button" className="btn btn-primary btn-pill border border-primary" onClick={this.handleShowMotorResult} placeholder="افزودن موتور" readOnly />
                            </CFormGroup>
                        </CCol>
                      </CRow>
                      {motorResult}
                      ...
                      <CRow>
                        ...
                        <CCol xs="12" md="6">
                            ...
                            <CInput  name="button" className="btn btn-primary btn-pill border border-primary" onClick={this.handleShowCustomeResult} placeholder="افزودن مشتری" readOnly />
                                {/* <CInput name="" onClick={this.handleShowCustomeResult} placeholder="افزودن مشتری" required /> */}
                            </CFormGroup>
                        </CCol> 
                      </CRow>
                        {customerResut}
